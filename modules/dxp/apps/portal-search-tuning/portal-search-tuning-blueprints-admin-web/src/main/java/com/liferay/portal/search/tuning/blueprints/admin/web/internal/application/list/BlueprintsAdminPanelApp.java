...
package com.liferay.portal.search.tuning.blueprints.admin.web.internal.application.list;
...
public class BlueprintsAdminPanelApp extends BasePanelApp {
	...
	@Override
	@Reference(
		target = "(javax.portlet.name=" + BlueprintsPortletKeys.BLUEPRINTS_ADMIN + ")",
		unbind = "-"
	)
