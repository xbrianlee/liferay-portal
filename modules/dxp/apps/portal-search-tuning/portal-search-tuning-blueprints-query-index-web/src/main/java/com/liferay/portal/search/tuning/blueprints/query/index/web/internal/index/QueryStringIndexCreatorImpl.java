 ...
 */
@Component(service = QueryStringIndexCreator.class)
public class QueryStringIndexCreatorImpl implements QueryStringIndexCreator {

	@Override
	public void create(QueryStringIndexName queryStringIndexName) {
	...
	@Override
	public void delete(QueryStringIndexName queryStringIndexName) {
	...
	protected static final String INDEX_SETTINGS_RESOURCE_NAME =
		"/META-INF/search/liferay-search-tuning-blueprints-query-index.json";
