...
package com.liferay.portal.search.tuning.blueprints.query.index.web.internal.index.creation.model.listener;
...
public class QueryStringIndexCreationCompanyModelListener
	...
	public void onBeforeRemove(Company company) {
		...
		_queryStringIndexCreator.delete(queryStringIndexName);
	}
