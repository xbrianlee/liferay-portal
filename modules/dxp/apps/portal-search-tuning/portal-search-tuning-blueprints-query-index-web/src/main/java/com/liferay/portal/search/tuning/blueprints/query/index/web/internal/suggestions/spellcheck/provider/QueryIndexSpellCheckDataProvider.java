...
package com.liferay.portal.search.tuning.blueprints.query.index.web.internal.suggestions.spellcheck.provider;
...
public class QueryIndexSpellCheckDataProvider
	...
	public List<Suggestion> getSuggestions(
		...
		if (!_queryIndexConfiguration.enableSpellcheckDataProvider()) {
	...
	public int getWeight() {
		return _queryIndexConfiguration.spellCheckDataProviderWeight();
	}
