...
package com.liferay.portal.search.tuning.blueprints.misspellings.web.internal.application.list;
...
public class MisspellingsPanelApp extends BasePanelApp {

	@Override
	public String getPortletId() {
		return MisspellingsPortletKeys.MISSPELLINGS;
	}
	...
	@Override
	@Reference(
		target = "(javax.portlet.name=" + MisspellingsPortletKeys.MISSPELLINGS + ")",
		unbind = "-"
	)
