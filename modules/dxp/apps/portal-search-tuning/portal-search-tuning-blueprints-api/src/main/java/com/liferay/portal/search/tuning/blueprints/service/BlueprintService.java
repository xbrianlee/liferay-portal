...
public interface BlueprintService extends BaseService {
	 ...
	 * NOTE FOR DEVELOPERS:
	 *
	 * Never modify this interface directly. Add custom service methods to <code>com.liferay.portal.search.tuning.blueprints.service.impl.BlueprintServiceImpl</code> and rerun ServiceBuilder to automatically copy the method declarations to this interface. Consume the blueprint remote service via injection or a <code>org.osgi.util.tracker.ServiceTracker</code>. Use {@link BlueprintServiceUtil} if injection and service tracking are not available.
	 */
