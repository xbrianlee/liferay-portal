...
package com.liferay.portal.search.tuning.blueprints.internal.validator.util;
 ...
 */
public class BlueprintJSONValidatorUtil {
	...
	public static void validate(String json, InputStream inputStream)
		...
		try {
			...
			SchemaLoader schemaLoader = SchemaLoader.builder(
				...
				"classpath://com/liferay/portal/search/tuning/blueprints" +
					"/internal/validator/dependencies/"
			).build();
	...
	private static final Log _log = LogFactoryUtil.getLog(
		BlueprintJSONValidatorUtil.class);
