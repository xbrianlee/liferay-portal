 ...
 * @author Wade Cao
 */
public class NotExistsConditionHandlerTest
	...
	public void setUp() throws Exception {
		...
		setUpFieldValues(_notExistsConditionHandler);
	}
	...
	public void testIsTrue() {
		...
		Assert.assertFalse(
			_notExistsConditionHandler.isTrue(
	...
	private final NotExistsConditionHandler _notExistsConditionHandler =
		new NotExistsConditionHandler();
