 ...
 * @author Wade Cao
 */
public class EqualsConditionHandlerTest extends BaseConditionHandlerTestCase {
	...
	public void setUp() throws Exception {
		...
		setUpFieldValues(_equalsConditionHandler);
	}
	...
	public void testIsTrue() {
		...
		Assert.assertTrue(
			_equalsConditionHandler.isTrue(
	...
	private final EqualsConditionHandler _equalsConditionHandler =
