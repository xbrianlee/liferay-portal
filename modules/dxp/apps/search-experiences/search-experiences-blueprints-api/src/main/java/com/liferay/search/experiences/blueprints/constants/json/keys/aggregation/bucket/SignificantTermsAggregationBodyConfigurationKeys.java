 ...
 */
public enum SignificantTermsAggregationBodyConfigurationKeys {

	BACKGROUND_FILTER("background_filter"), CHI_SQUARE("chi_square"),
	EXCLUDE("exclude"), EXECUTION_HINT("execution_hint"), FIELD("field"),
	GND("gnd"), INCLUDE("include"), JLH("jlh"), MIN_DOC_COUNT("min_doc_count"),
	...
	public static SignificantTermsAggregationBodyConfigurationKeys
		findByJsonKey(String jsonKey) {

		Stream<SignificantTermsAggregationBodyConfigurationKeys> stream =
			Arrays.stream(
				SignificantTermsAggregationBodyConfigurationKeys.values());
	...
	private SignificantTermsAggregationBodyConfigurationKeys(String jsonKey) {
		_jsonKey = jsonKey;
	}
