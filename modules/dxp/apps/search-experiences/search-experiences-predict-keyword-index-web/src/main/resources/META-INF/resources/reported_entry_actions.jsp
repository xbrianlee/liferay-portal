...
KeywordEntry queryString = (KeywordEntry)row.getObject();

String keywordEntryId = queryString.getKeywordEntryId();
%>
...
>
	...
	<portlet:actionURL name="<%= KeywordIndexMVCCommandNames.EDIT_KEYWORD_ENTRY %>" var="activateEntryURL">
		<portlet:param name="<%= KeywordIndexWebKeys.STATUS %>" value="<%= KeywordEntryStatus.ACTIVE.name() %>" />
		<portlet:param name="redirect" value="<%= currentURL %>" />
		<portlet:param name="<%= KeywordIndexWebKeys.KEYWORD_ENTRY_ID %>" value="<%= keywordEntryId %>" />
	</portlet:actionURL>
