...
public abstract class BaseSearchResultResourceImpl
	...
	@Parameters(
		value = {
			@Parameter(in = ParameterIn.QUERY, name = "labels"),
	...
	public SearchResult getFederatedSearchResults(
			@Parameter(hidden = true) @QueryParam("labels") String labels,
			@Parameter(hidden = true) @QueryParam("locale") String locale,
			@NotNull @Parameter(hidden = true) @QueryParam("query") String
				query,
			@Parameter(hidden = true) @QueryParam("size") Integer size,
			@Parameter(hidden = true) @QueryParam("page") Integer page)
		throws Exception {
	...
	public void create(
			java.util.Collection<SearchResult> searchResults,
